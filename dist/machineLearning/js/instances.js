...
export function getInstances(camera){
    ...
    instances[5] = (p) => {
        if (p <= 0) {
            ...
            if(p < 1) {
              ...
              rampTo(p, zoom[4], 350 / LoadData.size19[0], _camera);
            }
    ...
    instances[9] = (p) => {
        if (p <= 0) {
            ...
            if(p<1){
              alterUniform(LoadData.sl29,10 + 0/2 * 38 + p* 1 /2 * 38,"depth");
            }
        }
        if (p === 1 && !once[9]) {
            factors[9] = factor;
    ...
    instances[10] = (p) => {
        if (p <= 0) {
            ...
            if(p<1){
              alterUniform(LoadData.sl29,10 + 1/2 * 38 + p* 1 /2 * 38,"depth");
            }
        }
        if (p === 1 && !once[10]) {
            factors[10] = factor;
    ...
    instances[14] = (p) => {
        ...
        if (p === 1 && !once[14]) {
            factors[14] = factor;
            predecessor[26] = predecessor[14] + factor /27;
            listenerRemover[26] = uos(predecessor[14] , predecessor[14] + factor /27, p => instances[26](p));
            once[14] = true;
    ...
    instances[26] = (p) => {
        if (p <= 0) {
            alterUniform(LoadData.sl52,0,"u_opacity");
        } else {
            if(p < 1){
              alterUniform(LoadData.sl52,rampIn(p),"u_opacity");
        ...
        if (p === 1 && !once[26]) {
            factors[26] = factor;
            predecessor[25] = predecessor[26] + factor /27;
            listenerRemover[25] = uos(predecessor[26] , predecessor[26] + factor /27, p => instances[25](p));
            once[26] = true;
    ...
    instances[25] = (p) => {
        if (p <= 0) {
            ...
            if(p<1){
              alterUniform(LoadData.sl52,10 + 0/4 * 38 + p* 1 /4 * 38,"depth");
            }
        }
        if (p === 1 && !once[25]) {
            factors[25] = factor;
            predecessor[15] = predecessor[25] + factor /27;
            listenerRemover[15] = uos(predecessor[25] , predecessor[25] + factor /27, p => instances[15](p));
            once[25] = true;
    ...
    instances[15] = (p) => {
        if (p <= 0) {
            ...
            if(p<1){
              alterUniform(LoadData.sl52,10 + 1/4 * 38 + p* 1 /4 * 38,"depth");
            }
        }
        if (p === 1 && !once[15]) {
            factors[15] = factor;
            predecessor[16] = predecessor[15] + factor /27;
            listenerRemover[16] = uos(predecessor[15] , predecessor[15] + factor /27, p => instances[16](p));
            once[15] = true;
    ...
    instances[16] = (p) => {
        if (p <= 0) {
            ...
            if(p<1){
              alterUniform(LoadData.sl52,10 + 2/4 * 38 + p* 1 /4 * 38,"depth");
            }
        }
        if (p === 1 && !once[16]) {
            factors[16] = factor;
            predecessor[17] = predecessor[16] + factor /27;
            listenerRemover[17] = uos(predecessor[16] , predecessor[16] + factor /27, p => instances[17](p));
            once[16] = true;
    ...
    instances[17] = (p) => {
        if (p <= 0) {
            ...
            document.getElementById("37").style.zIndex = "19";
            document.getElementById("37").style.opacity = ramp(p);
            if(p<1){
              alterUniform(LoadData.sl52,10 + 3/4 * 38 + p* 1 /4 * 38,"depth");
            }
        }
        if (p === 1 && !once[17]) {
            factors[17] = factor;
            predecessor[21] = predecessor[17] + factor /27;
            listenerRemover[21] = uos(predecessor[17] , predecessor[17] + factor /27, p => instances[21](p));
            once[17] = true;
    ...
    instances[21] = (p) => {
        if (p <= 0) {
            ...
            document.getElementById("44").style.zIndex = "20";
            if(p < 1) document.getElementById("44").style.opacity = rampIn(p);
            alterUniform(LoadData.sl52,rampOut(p),"u_opacity");
        }
        if (p === 1 && !once[21]) {
            factors[21] = factor;
            predecessor[22] = predecessor[21] + factor /27;
            listenerRemover[22] = uos(predecessor[21] , predecessor[21] + factor /27, p => instances[22](p));
            once[21] = true;
    ...
    instances[22] = (p) => {
        if (p <= 0) {
            ...
            document.getElementById("46").style.zIndex = "21";
    ...
    instances[23] = (p) => {
        if (p <= 0) {
            ...
            document.getElementById("47").style.zIndex = "22";
    ...
    instances[24] = (p) => {
        if (p <= 0) {
            ...
            document.getElementById("48").style.zIndex = "23";
            document.getElementById("48").style.opacity = ramp(p);
            document.getElementById("44").style.opacity = rampOut(p);
        }
        if (p === 1 && !once[24]) {
            factors[24] = factor;
            predecessor[18] = predecessor[24] + factor /27;
            listenerRemover[18] = uos(predecessor[24] , predecessor[24] + factor /27, p => instances[18](p));
            once[24] = true;
    ...
    instances[18] = (p) => {
        if (p <= 0) {
            ...
            document.getElementById("38").style.zIndex = "24";
    ...
    instances[19] = (p) => {
        if (p <= 0) {
            ...
            document.getElementById("41").style.zIndex = "25";
            document.getElementById("41").style.opacity = ramp(p);
        }
        if (p === 1 && !once[19]) {
            factors[19] = factor;
            predecessor[20] = predecessor[19] + factor /27;
            listenerRemover[20] = uos(predecessor[19] , predecessor[19] + factor /27, p => instances[20](p));
            once[19] = true;
    ...
    instances[20] = (p) => {
        if (p <= 0) {
            ...
            document.getElementById("43").style.zIndex = "26";
