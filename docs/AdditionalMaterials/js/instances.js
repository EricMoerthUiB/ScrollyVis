...
export function getInstances(camera){
     ...
     once[id] = false;
     let start;
     let pred17 = [35,32,19,18,17,16,33,22,26,21,20,34,25,27,24,23];
     predecessor[1] = 1/26;
     start = 1;
    ...
    instances[1] = (p) => {
        ...
        if (p === 1 && !once[1]) {
            factors[1] = factor;
            predecessor[2] = predecessor[1] + factor /26;
            listenerRemover[2] = uos(predecessor[1] , predecessor[1] + factor /26, p => instances[2](p));
            once[1] = true;
        }
    };
    once[2] = false;
    instances[2] = (p) => {
        ...
        if (p === 1 && !once[2]) {
            factors[2] = factor;
            predecessor[3] = predecessor[2] + factor /26;
            listenerRemover[3] = uos(predecessor[2] , predecessor[2] + factor /26, p => instances[3](p));
            once[2] = true;
        }
    };
    once[3] = false;
    instances[3] = (p) => {
        ...
        if (p === 1 && !once[3]) {
            factors[3] = factor;
            predecessor[4] = predecessor[3] + factor /26;
            listenerRemover[4] = uos(predecessor[3] , predecessor[3] + factor /26, p => instances[4](p));
            once[3] = true;
        }
    };
    once[4] = false;
    instances[4] = (p) => {
        ...
        if (p === 1 && !once[4]) {
            factors[4] = factor;
            predecessor[5] = predecessor[4] + factor /26;
            listenerRemover[5] = uos(predecessor[4] , predecessor[4] + factor /26, p => instances[5](p));
            once[4] = true;
        }
    };
    once[5] = false;
    instances[5] = (p) => {
        ...
        if (p === 1 && !once[5]) {
            factors[5] = factor;
            predecessor[6] = predecessor[5] + factor /26;
            listenerRemover[6] = uos(predecessor[5] , predecessor[5] + factor /26, p => instances[6](p));
            once[5] = true;
        }
    };
    once[6] = false;
    instances[6] = (p) => {
        ...
        if (p === 1 && !once[6]) {
            factors[6] = factor;
            predecessor[7] = predecessor[6] + factor /26;
            listenerRemover[7] = uos(predecessor[6] , predecessor[6] + factor /26, p => instances[7](p));
            once[6] = true;
        }
    };
    once[7] = false;
    instances[7] = (p) => {
        ...
        if (p === 1 && !once[7]) {
            factors[7] = factor;
            predecessor[8] = predecessor[7] + factor /26;
            listenerRemover[8] = uos(predecessor[7] , predecessor[7] + factor /26, p => instances[8](p));
            once[7] = true;
        }
    };
    once[8] = false;
    instances[8] = (p) => {
        ...
        if (p === 1 && !once[8]) {
            factors[8] = factor;
            predecessor[9] = predecessor[8] + factor /26;
            listenerRemover[9] = uos(predecessor[8] , predecessor[8] + factor /26, p => instances[9](p));
            once[8] = true;
        }
    };
    once[9] = false;
    instances[9] = (p) => {
        ...
        if (p === 1 && !once[9]) {
            factors[9] = factor;
            predecessor[10] = predecessor[9] + factor /26;
            listenerRemover[10] = uos(predecessor[9] , predecessor[9] + factor /26, p => instances[10](p));
            once[9] = true;
        }
    };
    once[10] = false;
    instances[10] = (p) => {
        ...
        if (p === 1 && !once[10]) {
            factors[10] = factor;
            predecessor[11] = predecessor[10] + factor /26;
            listenerRemover[11] = uos(predecessor[10] , predecessor[10] + factor /26, p => instances[11](p));
            once[10] = true;
        }
    };
    once[11] = false;
    instances[11] = (p) => {
        ...
        if (p === 1 && !once[11]) {
            factors[11] = factor;
            predecessor[12] = predecessor[11] + factor /26;
            listenerRemover[12] = uos(predecessor[11] , predecessor[11] + factor /26, p => instances[12](p));
            once[11] = true;
        }
    };
    once[12] = false;
    instances[12] = (p) => {
        ...
        if (p === 1 && !once[12]) {
            factors[12] = factor;
            predecessor[13] = predecessor[12] + factor /26;
            listenerRemover[13] = uos(predecessor[12] , predecessor[12] + factor /26, p => instances[13](p));
            once[12] = true;
        }
    };
    once[13] = false;
    instances[13] = (p) => {
        ...
        if (p === 1 && !once[13]) {
            factors[13] = factor;
            predecessor[28] = predecessor[13] + factor /26;
            listenerRemover[28] = uos(predecessor[13] , predecessor[13] + factor /26, p => instances[28](p));
            once[13] = true;
        }
    };
    once[28] = false;
    instances[28] = (p) => {
        ...
        if (p === 1 && !once[28]) {
            factors[28] = factor;
            predecessor[29] = predecessor[28] + factor /26;
            listenerRemover[29] = uos(predecessor[28] , predecessor[28] + factor /26, p => instances[29](p));
            once[28] = true;
        }
    };
    once[29] = false;
    instances[29] = (p) => {
        ...
        if (p === 1 && !once[29]) {
            factors[29] = factor;
            predecessor[30] = predecessor[29] + factor /26;
            listenerRemover[30] = uos(predecessor[29] , predecessor[29] + factor /26, p => instances[30](p));
            once[29] = true;
        }
    };
    once[30] = false;
    instances[30] = (p) => {
        if (p <= 0) {
            ...
            document.getElementById("32").style.zIndex = "16";
            if(p < 1) document.getElementById("32").style.opacity = rampIn(p);
        }
        if (p === 1 && !once[30]) {
            factors[30] = factor;
            predecessor[31] = predecessor[30] + factor /26;
            listenerRemover[31] = uos(predecessor[30] , predecessor[30] + factor /26, p => instances[31](p));
            once[30] = true;
        }
    };
    once[31] = false;
    instances[31] = (p) => {
        if (p <= 0) {
            ...
            document.getElementById("33").style.zIndex = "17";
            document.getElementById("33").style.opacity = ramp(p);
        }
        if (p === 1 && !once[31]) {
            factors[31] = factor;
            predecessor[14] = predecessor[31] + factor /26;
            listenerRemover[14] = uos(predecessor[31] , predecessor[31] + factor /26, p => instances[14](p));
            once[31] = true;
        }
    };
    once[14] = false;
    instances[14] = (p) => {
        if (p <= 0) {
            ...
            document.getElementById("16").style.zIndex = "18";
            document.getElementById("16").style.opacity = ramp(p);
            document.getElementById("32").style.opacity = rampOut(p);
        }
        if (p === 1 && !once[14]) {
            factors[14] = factor;
            predecessor[15] = predecessor[14] + factor /26;
            listenerRemover[15] = uos(predecessor[14] , predecessor[14] + factor /26, p => instances[15](p));
            once[14] = true;
        }
    };
    once[15] = false;
    instances[15] = (p) => {
        if (p <= 0) {
            ...
            document.getElementById("17").style.zIndex = "19";
            document.getElementById("17").style.opacity = ramp(p);
            if (p < 1 && once[15]) {
                once[15] = false;
                factor = factors[15];
                [listenerRemover, once] = removeListenersAndOnces(pred17, listenerRemover, once)
            }
        }
        if (p === 1 && !once[15]) {
            factors[15] = factor;
            if (document.getElementsByName("question17")[0].checked) {
                predecessor[16] = predecessor[15] + factor /26;
                listenerRemover[16] = uos(predecessor[15], predecessor[15] + factor / 26, p => instances[16](p));
            }
            if (document.getElementsByName("question17")[1].checked) {
                predecessor[20] = predecessor[15] + factor /26;
                listenerRemover[20] = uos(predecessor[15], predecessor[15] + factor / 26, p => instances[20](p));
            }
            if (document.getElementsByName("question17")[2].checked) {
                predecessor[23] = predecessor[15] + factor /26;
                listenerRemover[23] = uos(predecessor[15], predecessor[15] + factor / 26, p => instances[23](p));
            }
            once[15] = true;
        }
    };
    ...
    instances[16] = (p) => {
        if (p <= 0) {
            ...
            document.getElementById("18").style.zIndex = "20";
            if(p < 1) document.getElementById("18").style.opacity = rampIn(p);
        }
        if (p === 1 && !once[16]) {
            factors[16] = factor;
            predecessor[17] = predecessor[16] + factor /26;
            listenerRemover[17] = uos(predecessor[16] , predecessor[16] + factor /26, p => instances[17](p));
            once[16] = true;
        }
    };
    once[17] = false;
    instances[17] = (p) => {
        if (p <= 0) {
            ...
            document.getElementById("19").style.zIndex = "21";
            document.getElementById("19").style.opacity = ramp(p);
        }
        if (p === 1 && !once[17]) {
            factors[17] = factor;
            predecessor[18] = predecessor[17] + factor /26;
            listenerRemover[18] = uos(predecessor[17] , predecessor[17] + factor /26, p => instances[18](p));
            once[17] = true;
        }
    };
    once[18] = false;
    instances[18] = (p) => {
        if (p <= 0) {
            ...
            document.getElementById("20").style.zIndex = "22";
            document.getElementById("20").style.opacity = ramp(p);
        }
        if (p === 1 && !once[18]) {
            factors[18] = factor;
            predecessor[19] = predecessor[18] + factor /26;
            listenerRemover[19] = uos(predecessor[18] , predecessor[18] + factor /26, p => instances[19](p));
            once[18] = true;
        }
    };
    once[19] = false;
    instances[19] = (p) => {
        if (p <= 0) {
            ...
            document.getElementById("21").style.zIndex = "23";
            document.getElementById("21").style.opacity = ramp(p);
            document.getElementById("18").style.opacity = rampOut(p);
        }
        if (p === 1 && !once[19]) {
            factors[19] = factor;
            predecessor[32] = predecessor[19] + factor /26;
            listenerRemover[32] = uos(predecessor[19] , predecessor[19] + factor /26, p => instances[32](p));
            once[19] = true;
        }
    };
    once[32] = false;
    instances[32] = (p) => {
        if (p <= 0) {
            ...
            document.getElementById("34").style.zIndex = "24";
            document.getElementById("34").style.opacity = rampIn(p);
        }
        if (p === 1 && !once[32]) {
            factors[32] = factor;
            predecessor[35] = predecessor[32] + factor /26;
            listenerRemover[35] = uos(predecessor[32] , predecessor[32] + factor /26, p => instances[35](p));
            once[32] = true;
        }
    };
    once[35] = false;
    ...
    instances[20] = (p) => {
        if (p <= 0) {
            ...
            document.getElementById("22").style.zIndex = "20";
            if(p < 1) document.getElementById("22").style.opacity = rampIn(p);
        }
        if (p === 1 && !once[20]) {
            factors[20] = factor;
            predecessor[21] = predecessor[20] + factor /26;
            listenerRemover[21] = uos(predecessor[20] , predecessor[20] + factor /26, p => instances[21](p));
            once[20] = true;
        }
    };
    once[21] = false;
    instances[21] = (p) => {
        if (p <= 0) {
            ...
            document.getElementById("23").style.zIndex = "21";
            document.getElementById("23").style.opacity = ramp(p);
        }
        if (p === 1 && !once[21]) {
            factors[21] = factor;
            predecessor[26] = predecessor[21] + factor /26;
            listenerRemover[26] = uos(predecessor[21] , predecessor[21] + factor /26, p => instances[26](p));
            once[21] = true;
        }
    };
    once[26] = false;
    instances[26] = (p) => {
        if (p <= 0) {
            ...
            document.getElementById("28").style.zIndex = "22";
            document.getElementById("28").style.opacity = ramp(p);
        }
        if (p === 1 && !once[26]) {
            factors[26] = factor;
            predecessor[22] = predecessor[26] + factor /26;
            listenerRemover[22] = uos(predecessor[26] , predecessor[26] + factor /26, p => instances[22](p));
            once[26] = true;
        }
    };
    once[22] = false;
    instances[22] = (p) => {
        if (p <= 0) {
            ...
            document.getElementById("24").style.zIndex = "23";
            document.getElementById("24").style.opacity = ramp(p);
            document.getElementById("22").style.opacity = rampOut(p);
        }
        if (p === 1 && !once[22]) {
            factors[22] = factor;
            predecessor[33] = predecessor[22] + factor /26;
            listenerRemover[33] = uos(predecessor[22] , predecessor[22] + factor /26, p => instances[33](p));
            once[22] = true;
        }
    };
    once[33] = false;
    instances[33] = (p) => {
        ...
        if (p === 1 && !once[33]) {
            factors[33] = factor;
            predecessor[35] = predecessor[33] + factor /26;
            listenerRemover[35] = uos(predecessor[33] , predecessor[33] + factor /26, p => instances[35](p));
            once[33] = true;
        }
    };
    once[23] = false;
    instances[23] = (p) => {
        if (p <= 0) {
            ...
            document.getElementById("25").style.zIndex = "20";
            if(p < 1) document.getElementById("25").style.opacity = rampIn(p);
        }
        if (p === 1 && !once[23]) {
            factors[23] = factor;
            predecessor[24] = predecessor[23] + factor /26;
            listenerRemover[24] = uos(predecessor[23] , predecessor[23] + factor /26, p => instances[24](p));
            once[23] = true;
        }
    };
    once[24] = false;
    instances[24] = (p) => {
        if (p <= 0) {
            ...
            document.getElementById("26").style.zIndex = "21";
            document.getElementById("26").style.opacity = ramp(p);
        }
        if (p === 1 && !once[24]) {
            factors[24] = factor;
            predecessor[27] = predecessor[24] + factor /26;
            listenerRemover[27] = uos(predecessor[24] , predecessor[24] + factor /26, p => instances[27](p));
            once[24] = true;
        }
    };
    once[27] = false;
    instances[27] = (p) => {
        ...
        if (p === 1 && !once[27]) {
            factors[27] = factor;
            predecessor[25] = predecessor[27] + factor /26;
            listenerRemover[25] = uos(predecessor[27] , predecessor[27] + factor /26, p => instances[25](p));
            once[27] = true;
        }
    };
    once[25] = false;
    instances[25] = (p) => {
        if (p <= 0) {
            ...
            document.getElementById("27").style.zIndex = "23";
            document.getElementById("27").style.opacity = ramp(p);
            document.getElementById("25").style.opacity = rampOut(p);
        }
        if (p === 1 && !once[25]) {
            factors[25] = factor;
            predecessor[34] = predecessor[25] + factor /26;
            listenerRemover[34] = uos(predecessor[25] , predecessor[25] + factor /26, p => instances[34](p));
            once[25] = true;
        }
    };
    once[34] = false;
    instances[34] = (p) => {
        ...
        if (p === 1 && !once[34]) {
            factors[34] = factor;
            predecessor[35] = predecessor[34] + factor /26;
            listenerRemover[35] = uos(predecessor[34] , predecessor[34] + factor /26, p => instances[35](p));
            once[34] = true;
        }
    };
        return [start, instances,once,26];
}
